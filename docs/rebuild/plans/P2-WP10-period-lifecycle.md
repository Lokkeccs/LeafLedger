...
- **Phase:** 2 (ledger core)
- **State:** done. **B2.1–B2.5 are resolved** and the transition/boundary golden fixtures are captured. Authorization, bootstrap, posting-boundary, gap, and closed/locked acceptance coverage are now present. QA PASS 2026-07-12.
