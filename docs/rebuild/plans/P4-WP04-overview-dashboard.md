...
**DONE — PR #39 merged to `main` 2026-07-20.** LL Git rebased the completed WP04 work onto `origin/main`, committed all existing changes, pushed the branch, and opened PR #39 (`P4-WP04: add overview dashboard`). The PR merged as `a9a026c`; WP04a and WP04b are complete. No blocker remains. Next: P4-WP05 planning/implementation.
