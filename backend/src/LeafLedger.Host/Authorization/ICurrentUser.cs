...
public sealed class HttpContextCurrentUser : ICurrentUser
{
    ...
    public Guid? SubjectId
    {
        get
        {
            ...
            // The immutable object id (oid) is a GUID for both organizational and
            // personal Microsoft accounts, whereas the personal-account `sub` is a
            // non-GUID pairwise identifier. Prefer `oid`, falling back to `sub`.
