...
public static class ModulePermissions
{
    ...
    public const string ManagePartners = "partners.manage";
    ...
    public static bool Allows(SpaceRole role, string permission) =>
        role switch
        {
            ...
            SpaceRole.Member => permission is PostLedger or ReverseLedger or ReadLedger or ManagePartners,
            SpaceRole.Viewer => permission is ReadLedger,
            _ => false,
        };

    private static bool IsKnownPermission(string permission) =>
        permission is PostLedger or ReverseLedger or ReadLedger or ClosePeriod or ManagePeriods or ManageMembers or ManageAccounts or ManagePartners;
}